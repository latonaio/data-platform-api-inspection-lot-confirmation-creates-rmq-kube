...
import (
	"context"
	dpfm_api_caller "data-platform-api-inspection-lot-confirmation-creates-rmq-kube/DPFM_API_Caller"
	...
	"data-platform-api-inspection-lot-confirmation-creates-rmq-kube/config"
	"data-platform-api-inspection-lot-confirmation-creates-rmq-kube/existence_conf"
