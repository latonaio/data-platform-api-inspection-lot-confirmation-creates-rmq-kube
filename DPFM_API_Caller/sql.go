...
import (
	"context"
	dpfm_api_input_reader "data-platform-api-inspection-lot-confirmation-creates-rmq-kube/DPFM_API_Input_Reader"
	dpfm_api_output_formatter "data-platform-api-inspection-lot-confirmation-creates-rmq-kube/DPFM_API_Output_Formatter"
	dpfm_api_processing_formatter "data-platform-api-inspection-lot-confirmation-creates-rmq-kube/DPFM_API_Processing_Formatter"
	"data-platform-api-inspection-lot-confirmation-creates-rmq-kube/sub_func_complementer"
	"sync"
...
func (c *DPFMAPICaller) headerCreateSql(
	...
	res, err := c.rmq.SessionKeepRequest(nil, c.conf.RMQ.QueueToSQL()[0], map[string]interface{}{"message": headerData, "function": "InspectionLotConfirmationHeader", "runtime_session_id": sessionID})
	if err != nil {
...
func headerIsUpdate(header *dpfm_api_processing_formatter.HeaderUpdates) bool {
	inspectionLot := header.InspectionLotConfirmation
